...
const Button: FC<ButtonProps> = ({
    ...
    const baseStyle =
        'px-10 py-3 font-roboto rounded-2xl transition-all duration-500 ease-in-out drop-shadow-xl hover:scale-105 hover:shadow-2xl transform transition-transform';
