...
export const Home = () => {
    return <section id="home" className="flex flex-row justify-evenly">
        <div>
            <Card title="RAMEZ" titleSize="text-8xl" subtitle="SOFTWARE ENGINEER" subtitleSize="text-6xl font-bold" text="I transform Ideas into Seamless Digital Experiences">
                <SocialMedia/>
            </Card>
