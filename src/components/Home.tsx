...
export const Home = () => {
    return <section id="home" className="flex flex-col-reverse lg:flex-row justify-evenly">
        <div className="mt-8 w-full lg:w-[38%]">
            ...
            <div className="flex flex-col sm:flex-row gap-6 sm:gap-8 md:gap-12 lg:gap-16 mt-6">
        ...
        <img 
            ...
            className="w-full lg:w-auto max-w-full h-auto transition-transform hover:scale-105 duration-500"
        />
    </section>
}
